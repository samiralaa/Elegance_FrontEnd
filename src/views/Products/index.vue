        ...
        <el-table v-loading="loading" :data="products"   class="table-responsivew" style="height: 70vh" dir="ltr" >
          <el-table-column :label="$t('Products.Image')" width="120">
            <template #default="{ row }">
              <el-image v-if="row.images && row.images.length > 0" :src="`${BASE_URL}/${row.images[0].path}`"
...
<<<<<<< HEAD
      <el-dialog v-model="showDiscountDialog" :title="$t('discount.add_discount')" :width="isMobile ? '90%' : '500px'"
        ...
        <el-form :model="discountForm" label-width="100px" class="discount-form">
          <el-form-item :label="$t('discount.start_date')">
            <el-date-picker v-model="discountForm.start_date" type="date" :placeholder="$t('discount.start_date_placeholder')"
              class="w-100" />
          </el-form-item>
          <el-form-item :label="$t('discount.duration_days')">
            <el-input v-model="discountForm.duration" type="number" :placeholder="$t('discount.duration_days_placeholder')"
              class="w-100" />
          </el-form-item>
          <el-form-item :label="$t('discount.discount_value')">
            <el-input v-model="discountForm.discount_value" type="number" :placeholder="$t('discount.discount_value_placeholder')"
              class="w-100" />
          </el-form-item>
