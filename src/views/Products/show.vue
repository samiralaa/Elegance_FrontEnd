<template>
    <div class="product-detail-container">
      <el-card v-if="!loading && !error" class="product-card">
        ...
        <!-- Product Information -->
        <div class="info">
          <p><strong>Price:</strong> {{ product.price }} {{ product.currency?.name_en || '' }}</p>
          <p><strong>Availability:</strong> {{ product.is_available ? 'Available' : 'Not Available' }}</p>
          <p><strong>Description (EN):</strong> {{ product.description_en || 'N/A' }}</p>
          <p><strong>Description (AR):</strong> <span dir="rtl">{{ product.description_ar || 'N/A' }}</span></p>
        </div>
      </el-card>
