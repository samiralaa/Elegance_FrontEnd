  ...
  setup() {
    ...
    const fetchSalesOverview = async () => {
      try {
        ...
        const response = await axios.get('http://127.0.0.1:8000/api/dashboard/sales-overview')
    ...
    const fetchTotalProducts = async () => {
      try {
        ...
        axios.defaults.headers.common['Authorization'] = `Bearer ${tokenData.token}`
        const response = await axios.get('http://127.0.0.1:8000/api/dashboard/total-products')
    ...
    const fetchTotalOrders = async () => {
      try {
        ...
        axios.defaults.headers.common['Authorization'] = `Bearer ${tokenData.token}`
        const response = await axios.get('http://127.0.0.1:8000/api/dashboard/total-orders')
    ...
    const fetchRecentOrders = async () => {
      try {
        ...
        axios.defaults.headers.common['Authorization'] = `Bearer ${tokenData.token}`
        const response = await axios.get('http://127.0.0.1:8000/api/dashboard/recent-orders')
