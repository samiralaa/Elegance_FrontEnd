    ...
    methods: {
      async fetchBrands() {
        try {
          ...
          const response = await axios.get('https://testback.eleganceoud.com//api/brands')
      ...
      async submitCategory() {
        try {
          ...
          const response = await axios.post('https://testback.eleganceoud.com//api/categories', formData, {
            headers: {
